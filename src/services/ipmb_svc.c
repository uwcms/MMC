...
// NOTE:  REQ_MSG_XMT_TRY_LIMIT changed from 5 to 10 between 2.3a and 2.3b
...
void check_incoming_msgs(void) {
  ...
  // pulse LED2 to indicate IPMI RCV activity
  program_LED(LED2_TBL_IDX, Local_Control, &LED_50ms_Flash_Activity);
