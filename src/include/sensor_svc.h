...
#define BKEND_5V_SENSOR                 (5)
#define BKEND_1p8V_SENSOR               (6)
#define BKEND_1p5V_SENSOR               (7)
#define BKEND_1p0VDD_SENSOR             (8)
#define BKEND_1p2VDD_SENSOR             (9)
#define BKEND_1p2VSC_SENSOR             (10)
#define BKEND_1p0MGT_SENSOR             (11)
#define PGOOD_SENSOR                    (12)
#define ALARM_LEVEL_SENSOR              (13)
#define FPGA_CONFIG_SENSOR              (14)
// payload-based sensors (ZYNQ)
#define ZYNQ_DIE_TEMP_SENSOR            (15)
#define ZYNQ_1P0VDD_SENSOR              (16)
...
#define LAST_ANALOG_SENSOR              BKEND_1p0MGT_SENSOR             // last sensor that requires scaling from ADC reading to 8-bit IPMI sensor value
#define FIRST_SENSOR_NUMBER             HOTSWAP_SENSOR                  // first sensor in list
#define LAST_SENSOR_NUMBER              ZYNQ_1P0VDD_SENSOR              // last sensor in list--NOTE, sensor numbers should be contiguous with NO GAPS so that for loops work to scan through them
...
#define SDR_BKEND_5V_SENSOR             (1+BKEND_5V_SENSOR)
...
#define SDR_BKEND_1p2VDD_SENSOR         (1+BKEND_1p2VDD_SENSOR)
#define SDR_BKEND_1p2VSC_SENSOR         (1+BKEND_1p2VSC_SENSOR)
#define SDR_BKEND_1p0MGT_SENSOR         (1+BKEND_1p0MGT_SENSOR)
