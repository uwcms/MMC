...
void initialize_sensor_table(void) {
  ...
  SensorData[BKEND_2p5V_SENSOR].readout_function = get_adc_channel_sensor_readout_value;
  SensorData[BKEND_2p5V_SENSOR].readout_func_arg = IADC_CH3;
  SensorData[BKEND_2p5V_SENSOR].pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_2p5V_SENSOR];
  SensorData[BKEND_2p5V_SENSOR].event_msg_ctl = SENSOREV_MSG_CTL_ENABLE_ALL_EVENTS_MASK;
  SensorData[BKEND_2p5V_SENSOR].active_context_code = SENSORACTV_BACKENDPWRON;
  SensorData[BKEND_2p5V_SENSOR].send_event_function = send_threshold_sensor_event;

  SensorData[BKEND_2p0V_SENSOR].readout_function = get_adc_channel_sensor_readout_value;
  SensorData[BKEND_2p0V_SENSOR].readout_func_arg = IADC_CH1;
  SensorData[BKEND_2p0V_SENSOR].pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_2p0V_SENSOR];
  SensorData[BKEND_2p0V_SENSOR].event_msg_ctl = SENSOREV_MSG_CTL_ENABLE_ALL_EVENTS_MASK;
  SensorData[BKEND_2p0V_SENSOR].active_context_code = SENSORACTV_BACKENDPWRON;
  SensorData[BKEND_2p0V_SENSOR].send_event_function = send_threshold_sensor_event;
  ...
  SensorData[AUX_12V_SENSOR].readout_function = get_adc_channel_sensor_readout_value;
  SensorData[AUX_12V_SENSOR].readout_func_arg = IADC_CH5;
  SensorData[AUX_12V_SENSOR].pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_AUX_12V_SENSOR];
  SensorData[AUX_12V_SENSOR].event_msg_ctl = 0;                                 // no events
  SensorData[AUX_12V_SENSOR].active_context_code = SENSORACTV_PAYLOADPWRON;
  SensorData[AUX_12V_SENSOR].send_event_function = send_threshold_sensor_event;

  SensorData[BKEND_1p0RMGT_SENSOR].readout_function = get_adc_channel_sensor_readout_value;
  SensorData[BKEND_1p0RMGT_SENSOR].readout_func_arg = XADC_CH0;
  SensorData[BKEND_1p0RMGT_SENSOR].pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_1p0RMGT_SENSOR];
  SensorData[BKEND_1p0RMGT_SENSOR].event_msg_ctl = SENSOREV_MSG_CTL_ENABLE_ALL_EVENTS_MASK;
  SensorData[BKEND_1p0RMGT_SENSOR].active_context_code = SENSORACTV_BACKENDPWRON;
  SensorData[BKEND_1p0RMGT_SENSOR].send_event_function = send_threshold_sensor_event;

  SensorData[BKEND_1p0LMGT_SENSOR].readout_function = get_adc_channel_sensor_readout_value;
  SensorData[BKEND_1p0LMGT_SENSOR].readout_func_arg = XADC_CH1;
  SensorData[BKEND_1p0LMGT_SENSOR].pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_1p0LMGT_SENSOR];
  SensorData[BKEND_1p0LMGT_SENSOR].event_msg_ctl = SENSOREV_MSG_CTL_ENABLE_ALL_EVENTS_MASK;
  SensorData[BKEND_1p0LMGT_SENSOR].active_context_code = SENSORACTV_BACKENDPWRON;
  SensorData[BKEND_1p0LMGT_SENSOR].send_event_function = send_threshold_sensor_event;

  SensorData[BKEND_1p2RMGT_SENSOR].readout_function = get_adc_channel_sensor_readout_value;
  SensorData[BKEND_1p2RMGT_SENSOR].readout_func_arg = XADC_CH2;
  SensorData[BKEND_1p2RMGT_SENSOR].pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_1p2RMGT_SENSOR];
  SensorData[BKEND_1p2RMGT_SENSOR].event_msg_ctl = SENSOREV_MSG_CTL_ENABLE_ALL_EVENTS_MASK;
  SensorData[BKEND_1p2RMGT_SENSOR].active_context_code = SENSORACTV_BACKENDPWRON;
  SensorData[BKEND_1p2RMGT_SENSOR].send_event_function = send_threshold_sensor_event;

  SensorData[BKEND_1p2LMGT_SENSOR].readout_function = get_adc_channel_sensor_readout_value;
  SensorData[BKEND_1p2LMGT_SENSOR].readout_func_arg = XADC_CH3;
  SensorData[BKEND_1p2LMGT_SENSOR].pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_1p2LMGT_SENSOR];
  SensorData[BKEND_1p2LMGT_SENSOR].event_msg_ctl = SENSOREV_MSG_CTL_ENABLE_ALL_EVENTS_MASK;
  SensorData[BKEND_1p2LMGT_SENSOR].active_context_code = SENSORACTV_BACKENDPWRON;
  SensorData[BKEND_1p2LMGT_SENSOR].send_event_function = send_threshold_sensor_event;

  SensorData[BKEND_1p0VDD_SENSOR].readout_function = get_adc_channel_sensor_readout_value;
  SensorData[BKEND_1p0VDD_SENSOR].readout_func_arg = XADC_CH4;
  ...
  SensorData[BKEND_1p5V_SENSOR].readout_func_arg = XADC_CH5;
  ...
  SensorData[BKEND_1p5VLDO_SENSOR].readout_function = get_adc_channel_sensor_readout_value;
  SensorData[BKEND_1p5VLDO_SENSOR].readout_func_arg = XADC_CH6;
  SensorData[BKEND_1p5VLDO_SENSOR].pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_1p5VLDO_SENSOR];
  SensorData[BKEND_1p5VLDO_SENSOR].event_msg_ctl = SENSOREV_MSG_CTL_ENABLE_ALL_EVENTS_MASK;
  SensorData[BKEND_1p5VLDO_SENSOR].active_context_code = SENSORACTV_BACKENDPWRON;
  SensorData[BKEND_1p5VLDO_SENSOR].send_event_function = send_threshold_sensor_event;

  SensorData[BKEND_1p3VLDO_SENSOR].readout_function = get_adc_channel_sensor_readout_value;
  SensorData[BKEND_1p3VLDO_SENSOR].readout_func_arg = XADC_CH7;
  SensorData[BKEND_1p3VLDO_SENSOR].pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_1p3VLDO_SENSOR];
  SensorData[BKEND_1p3VLDO_SENSOR].event_msg_ctl = SENSOREV_MSG_CTL_ENABLE_ALL_EVENTS_MASK;
  SensorData[BKEND_1p3VLDO_SENSOR].active_context_code = SENSORACTV_BACKENDPWRON;
  SensorData[BKEND_1p3VLDO_SENSOR].send_event_function = send_threshold_sensor_event;
  ...
  // these scaling factors are stored in the internal ADC driver module but are called
  ...
  SensorData[V7_DIE_TEMP_SENSOR].readout_function = get_pbs_readout_value;
  SensorData[V7_DIE_TEMP_SENSOR].readout_func_arg = PBS_OFFSET_V7_DIE;
  SensorData[V7_DIE_TEMP_SENSOR].pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_V7_DIE_TEMP_SENSOR];
  SensorData[V7_DIE_TEMP_SENSOR].event_msg_ctl = SENSOREV_MSG_CTL_ENABLE_ALL_EVENTS_MASK;
  SensorData[V7_DIE_TEMP_SENSOR].active_context_code = SENSORACTV_PAYLOADSOURCED;
  SensorData[V7_DIE_TEMP_SENSOR].send_event_function = send_threshold_sensor_event;
  ...
  SensorData[V7_1P0VDD_SENSOR].readout_function = get_pbs_readout_value;
  SensorData[V7_1P0VDD_SENSOR].readout_func_arg = PBS_OFFSET_V7_1P0VDD;
  SensorData[V7_1P0VDD_SENSOR].pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_V7_1P0VDD_SENSOR];
  SensorData[V7_1P0VDD_SENSOR].event_msg_ctl = SENSOREV_MSG_CTL_ENABLE_ALL_EVENTS_MASK;
  SensorData[V7_1P0VDD_SENSOR].active_context_code = SENSORACTV_PAYLOADSOURCED;
  SensorData[V7_1P0VDD_SENSOR].send_event_function = send_threshold_sensor_event;
}
...
void build_default_SDR_image(void) {
  ...
  pSDRm->IDtypelen = 0xc0|10;
  strcpy(&pSDRm->IDstring[0], "WISC CTP-7");
...
/* TEMPORARY PATCH:  14JAN14
  Using Aux power decouples two 150uF caps from the main supply, increasing on-board ripple.
  Mod of one cap may have made things better, but temporary workaround is to lower all of the bottom side thresholds by one volt
  pSDR->lower_noncritical_thr = 193;	  // 11.58 V
  pSDR->lower_critical_thr = 180;	      // 10.8 V	
  pSDR->lower_nonrecover_thr = 166;     // 9.96 V
  // LEAVE IN PLACE UNTIL REV A BOARDS ARE RETIRED
*/
  ...
  // Auxiliary 12V
  pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_AUX_12V_SENSOR];
  pSDR->hdr.recID_LSB = SDR_AUX_12V_SENSOR;
  pSDR->hdr.recID_MSB = 0;
  pSDR->hdr.SDRversion = SDR_VERSION;
  pSDR->hdr.rectype = 0x01;
  pSDR->hdr.reclength = sizeof(SDR_type_01h_t)-sizeof(SDR_entry_hdr_t);
  pSDR->ownerID = twi_state.ipmbl_addr;
  pSDR->sensornum = AUX_12V_SENSOR;
  pSDR->OEM = (SDR_OEM_FIELD_DEV_SENSOR_MASK & AUX_12V_SENSOR) | ((SDR_SYSMGR_CODE_NONE & SDR_OEM_FIELD_SYSMGR_CODE_MASK) << SDR_OEM_FIELD_SYSMGR_CODE_POS);
  pSDR->entityID = ENTITY_ID;
  pSDR->entityinstance = ENTITY_INSTANCE_BASE + twi_state.slotid;
  pSDR->sensorinit = 0x7f;
  pSDR->sensorcap = 0x43;                   // note:  reports that there are no events and no thresholds for sensor
  //pSDR->sensorcap = 0x5b;                   // note:  reports that there are no events from sensor
  pSDR->sensortype = 0x02;                  // type 2 = voltage
  pSDR->event_reading_type = THRESHOLD_EVENT_READING_TYPE;					// type 1 = thresholds
  event_mask = SENSOREV_UPPER_NONCRITICAL_HIGH_ASSERT_MASK | SENSOREV_LOWER_NONRECOVER_LOW_ASSERT_MASK |
    SENSOREV_LOWER_CRITICAL_LOW_ASSERT_MASK | SENSOREV_LOWER_NONCRITICAL_LOW_ASSERT_MASK |
  ...
  // Back End 2.5V
  pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_2p5V_SENSOR];
  pSDR->hdr.recID_LSB = SDR_BKEND_2p5V_SENSOR;
  pSDR->hdr.recID_MSB = 0;
  pSDR->hdr.SDRversion = SDR_VERSION;
  pSDR->hdr.rectype = 0x01;
  pSDR->hdr.reclength = sizeof(SDR_type_01h_t)-sizeof(SDR_entry_hdr_t);
  pSDR->ownerID = twi_state.ipmbl_addr;
  pSDR->sensornum = BKEND_2p5V_SENSOR;
  pSDR->OEM = (SDR_OEM_FIELD_DEV_SENSOR_MASK & BKEND_2p5V_SENSOR) | ((SDR_SYSMGR_CODE_NONE & SDR_OEM_FIELD_SYSMGR_CODE_MASK) << SDR_OEM_FIELD_SYSMGR_CODE_POS);
  pSDR->entityID = ENTITY_ID;
  pSDR->entityinstance = ENTITY_INSTANCE_BASE + twi_state.slotid;
  pSDR->sensorinit = 0x7f;
  pSDR->sensorcap = 0x58;
  ...
  pSDR->M_tol = 0;											
  pSDR->Rexp_Bexp = 0xc0;	
  // reading = (Volts) * (115 * RAW_VALUE + 0) * 0.0001   ==> reading = (0.0115 * RAW_VALUE) * Volts
  // min reading = 0 Volts, max reading = 2.9325 Volts
  pSDR->analog_flags = 7;	
  pSDR->nominal_reading = 217;          // 2.496 V
  pSDR->normal_max = 255;
  pSDR->normal_min = 0;	
  pSDR->sensor_max_reading = 255;	
  pSDR->sensor_min_reading = 0x00;
  pSDR->upper_nonrecover_thr = 239;     // 2.749 V
  pSDR->upper_critical_thr = 234;       // 2.691 V
  pSDR->upper_noncritical_thr = 228;    // 2.620 V
  pSDR->lower_noncritical_thr = 206;	  // 2.369 V
  pSDR->lower_critical_thr = 200;	      // 2.300 V	
  pSDR->lower_nonrecover_thr = 195;     // 2.243 V
  pSDR->pos_thr_hysteresis = 2;
  pSDR->neg_thr_hysteresis = 2;
  pSDR->IDtypelen = 0xc0|5;
  strcpy(pSDR->IDstring, "+2.5V");

  // Back End 2.0V
  pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_2p0V_SENSOR];
  pSDR->hdr.recID_LSB = SDR_BKEND_2p0V_SENSOR;
  pSDR->hdr.recID_MSB = 0;
  pSDR->hdr.SDRversion = SDR_VERSION;
  pSDR->hdr.rectype = 0x01;
  pSDR->hdr.reclength = sizeof(SDR_type_01h_t)-sizeof(SDR_entry_hdr_t);
  pSDR->ownerID = twi_state.ipmbl_addr;
  pSDR->sensornum = BKEND_2p0V_SENSOR;
  pSDR->OEM = (SDR_OEM_FIELD_DEV_SENSOR_MASK & BKEND_2p0V_SENSOR) | ((SDR_SYSMGR_CODE_NONE & SDR_OEM_FIELD_SYSMGR_CODE_MASK) << SDR_OEM_FIELD_SYSMGR_CODE_POS);
  pSDR->entityID = ENTITY_ID;
  pSDR->entityinstance = ENTITY_INSTANCE_BASE + twi_state.slotid;
  pSDR->sensorinit = 0x7f;
  pSDR->sensorcap = 0x58;
  ...
  pSDR->M_tol = 0;
  pSDR->Rexp_Bexp = 0xc0;
  // reading = (Volts) * (92 * RAW_VALUE + 0) * 0.0001   ==> reading = (0.0092 * RAW_VALUE) * Volts
  // min reading = 0 Volts, max reading = 2.346 Volts
  pSDR->analog_flags = 7;
  pSDR->nominal_reading = 217;          // 1.996 V
  pSDR->normal_max = 255;
  pSDR->normal_min = 0;
  pSDR->sensor_max_reading = 255;
  pSDR->sensor_min_reading = 0x00;
  pSDR->upper_nonrecover_thr = 239;     // 2.199 V
  pSDR->upper_critical_thr = 234;       // 2.153 V
  pSDR->upper_noncritical_thr = 228;    // 2.098 V
  pSDR->lower_noncritical_thr = 206;	  // 1.895 V
  pSDR->lower_critical_thr = 200;	      // 1.840 V
  pSDR->lower_nonrecover_thr = 195;     // 1.794 V
  pSDR->pos_thr_hysteresis = 2;
  pSDR->neg_thr_hysteresis = 2;
  pSDR->IDtypelen = 0xc0|5;
  strcpy(pSDR->IDstring, "+2.0V");
  ...
  // Back End 1.5V LDO Supply
  pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_1p5VLDO_SENSOR];
  pSDR->hdr.recID_LSB = SDR_BKEND_1p5VLDO_SENSOR;
  pSDR->hdr.recID_MSB = 0;
  pSDR->hdr.SDRversion = SDR_VERSION;
  pSDR->hdr.rectype = 0x01;
  pSDR->hdr.reclength = sizeof(SDR_type_01h_t)-sizeof(SDR_entry_hdr_t);
  pSDR->ownerID = twi_state.ipmbl_addr;
  pSDR->sensornum = BKEND_1p5VLDO_SENSOR;
  pSDR->OEM = (SDR_OEM_FIELD_DEV_SENSOR_MASK & BKEND_1p5VLDO_SENSOR) | ((SDR_SYSMGR_CODE_NONE & SDR_OEM_FIELD_SYSMGR_CODE_MASK) << SDR_OEM_FIELD_SYSMGR_CODE_POS);
  pSDR->entityID = ENTITY_ID;
  pSDR->entityinstance = ENTITY_INSTANCE_BASE + twi_state.slotid;
  pSDR->sensorinit = 0x7f;
  pSDR->sensorcap = 0x58;
  ...
  pSDR->neg_thr_hysteresis = 2;
  pSDR->IDtypelen = 0xc0|9;
  strcpy(pSDR->IDstring, "+1.5V LDO");

  // Back End 1.3V LDO Supply
  pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_1p3VLDO_SENSOR];
  pSDR->hdr.recID_LSB = SDR_BKEND_1p3VLDO_SENSOR;
  pSDR->hdr.recID_MSB = 0;
  pSDR->hdr.SDRversion = SDR_VERSION;
  pSDR->hdr.rectype = 0x01;
  pSDR->hdr.reclength = sizeof(SDR_type_01h_t)-sizeof(SDR_entry_hdr_t);
  pSDR->ownerID = twi_state.ipmbl_addr;
  pSDR->sensornum = BKEND_1p3VLDO_SENSOR;
  pSDR->OEM = (SDR_OEM_FIELD_DEV_SENSOR_MASK & BKEND_1p3VLDO_SENSOR) | ((SDR_SYSMGR_CODE_NONE & SDR_OEM_FIELD_SYSMGR_CODE_MASK) << SDR_OEM_FIELD_SYSMGR_CODE_POS);
  pSDR->entityID = ENTITY_ID;
  pSDR->entityinstance = ENTITY_INSTANCE_BASE + twi_state.slotid;
  pSDR->sensorinit = 0x7f;
  pSDR->sensorcap = 0x58;
  ...
  pSDR->M_tol = 0;
  pSDR->Rexp_Bexp = 0xc0;
  // reading = (Volts) * (65 * RAW_VALUE + 0) * 0.0001   ==> reading = (0.0065 * RAW_VALUE) * Volts
  // min reading = 0 Volts, max reading = 1.658 Volts
  pSDR->analog_flags = 7;
  pSDR->nominal_reading = 200;          // 1.300 V
  pSDR->normal_max = 255;
  pSDR->normal_min = 0;
  pSDR->sensor_max_reading = 255;
  pSDR->sensor_min_reading = 0x00;
  pSDR->upper_nonrecover_thr = 220;     // 1.430 V
  pSDR->upper_critical_thr = 215;       // 1.398 V
  pSDR->upper_noncritical_thr = 210;    // 1.365 V
  pSDR->lower_noncritical_thr = 190;	  // 1.235 V
  pSDR->lower_critical_thr = 185;	      // 1.203 V
  pSDR->lower_nonrecover_thr = 180;     // 1.170 V
  pSDR->pos_thr_hysteresis = 2;
  pSDR->neg_thr_hysteresis = 2;
  pSDR->IDtypelen = 0xc0|9;
  strcpy(pSDR->IDstring, "+1.3V LDO");

  // Back End 1.0V MGTL Supply
  pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_1p0LMGT_SENSOR];
  pSDR->hdr.recID_LSB = SDR_BKEND_1p0LMGT_SENSOR;
  pSDR->hdr.recID_MSB = 0;
  pSDR->hdr.SDRversion = SDR_VERSION;
  pSDR->hdr.rectype = 0x01;
  pSDR->hdr.reclength = sizeof(SDR_type_01h_t)-sizeof(SDR_entry_hdr_t);
  pSDR->ownerID = twi_state.ipmbl_addr;
  pSDR->sensornum =BKEND_1p0LMGT_SENSOR;
  pSDR->OEM = (SDR_OEM_FIELD_DEV_SENSOR_MASK & BKEND_1p0LMGT_SENSOR) | ((SDR_SYSMGR_CODE_NONE & SDR_OEM_FIELD_SYSMGR_CODE_MASK) << SDR_OEM_FIELD_SYSMGR_CODE_POS);
  pSDR->entityID = ENTITY_ID;
  pSDR->entityinstance = ENTITY_INSTANCE_BASE + twi_state.slotid;
  pSDR->sensorinit = 0x7f;
  pSDR->sensorcap = 0x58;
  ...
  pSDR->neg_thr_hysteresis = 2;
  pSDR->IDtypelen = 0xc0|11;
  strcpy(pSDR->IDstring, "+1.0V MGT L");

  // Back End 1.2V MGTL Supply
  pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_1p2LMGT_SENSOR];
  pSDR->hdr.recID_LSB = SDR_BKEND_1p2LMGT_SENSOR;
  pSDR->hdr.recID_MSB = 0;
  pSDR->hdr.SDRversion = SDR_VERSION;
  pSDR->hdr.rectype = 0x01;
  pSDR->hdr.reclength = sizeof(SDR_type_01h_t)-sizeof(SDR_entry_hdr_t);
  pSDR->ownerID = twi_state.ipmbl_addr;
  pSDR->sensornum =BKEND_1p2LMGT_SENSOR;
  pSDR->OEM = (SDR_OEM_FIELD_DEV_SENSOR_MASK & BKEND_1p2LMGT_SENSOR) | ((SDR_SYSMGR_CODE_NONE & SDR_OEM_FIELD_SYSMGR_CODE_MASK) << SDR_OEM_FIELD_SYSMGR_CODE_POS);
  pSDR->entityID = ENTITY_ID;
  pSDR->entityinstance = ENTITY_INSTANCE_BASE + twi_state.slotid;
  pSDR->sensorinit = 0x7f;
  pSDR->sensorcap = 0x58;
  ...
  pSDR->neg_thr_hysteresis = 2;
  pSDR->IDtypelen = 0xc0|11;
  strcpy(pSDR->IDstring, "+1.2V MGT L");

  // Back End 1.0V MGTL Supply
  pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_1p0RMGT_SENSOR];
  pSDR->hdr.recID_LSB = SDR_BKEND_1p0RMGT_SENSOR;
  pSDR->hdr.recID_MSB = 0;
  pSDR->hdr.SDRversion = SDR_VERSION;
  pSDR->hdr.rectype = 0x01;
  pSDR->hdr.reclength = sizeof(SDR_type_01h_t)-sizeof(SDR_entry_hdr_t);
  pSDR->ownerID = twi_state.ipmbl_addr;
  pSDR->sensornum =BKEND_1p0RMGT_SENSOR;
  pSDR->OEM = (SDR_OEM_FIELD_DEV_SENSOR_MASK & BKEND_1p0RMGT_SENSOR) | ((SDR_SYSMGR_CODE_NONE & SDR_OEM_FIELD_SYSMGR_CODE_MASK) << SDR_OEM_FIELD_SYSMGR_CODE_POS);
  pSDR->entityID = ENTITY_ID;
  pSDR->entityinstance = ENTITY_INSTANCE_BASE + twi_state.slotid;
  pSDR->sensorinit = 0x7f;
  pSDR->sensorcap = 0x58;
  ...
  pSDR->neg_thr_hysteresis = 2;
  pSDR->IDtypelen = 0xc0|11;
  strcpy(pSDR->IDstring, "+1.0V MGT R");

  // Back End 1.2V MGTL Supply
  pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_BKEND_1p2RMGT_SENSOR];
  pSDR->hdr.recID_LSB = SDR_BKEND_1p2RMGT_SENSOR;
  pSDR->hdr.recID_MSB = 0;
  pSDR->hdr.SDRversion = SDR_VERSION;
  pSDR->hdr.rectype = 0x01;
  pSDR->hdr.reclength = sizeof(SDR_type_01h_t)-sizeof(SDR_entry_hdr_t);
  pSDR->ownerID = twi_state.ipmbl_addr;
  pSDR->sensornum =BKEND_1p2RMGT_SENSOR;
  pSDR->OEM = (SDR_OEM_FIELD_DEV_SENSOR_MASK & BKEND_1p2RMGT_SENSOR) | ((SDR_SYSMGR_CODE_NONE & SDR_OEM_FIELD_SYSMGR_CODE_MASK) << SDR_OEM_FIELD_SYSMGR_CODE_POS);
  pSDR->entityID = ENTITY_ID;
  pSDR->entityinstance = ENTITY_INSTANCE_BASE + twi_state.slotid;
  pSDR->sensorinit = 0x7f;
  pSDR->sensorcap = 0x58;
  ...
  pSDR->neg_thr_hysteresis = 2;
  pSDR->IDtypelen = 0xc0|11;
  strcpy(pSDR->IDstring, "+1.2V MGT R");
  ...
  // V7 Die Temperature Sensor
  pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_V7_DIE_TEMP_SENSOR];
  pSDR->hdr.recID_LSB = SDR_V7_DIE_TEMP_SENSOR;
  pSDR->hdr.recID_MSB = 0;
  pSDR->hdr.SDRversion = SDR_VERSION;
  pSDR->hdr.rectype = 0x01;
  pSDR->hdr.reclength = sizeof(SDR_type_01h_t)-sizeof(SDR_entry_hdr_t);
  pSDR->ownerID = twi_state.ipmbl_addr;
  pSDR->sensornum = V7_DIE_TEMP_SENSOR;
  pSDR->OEM = (SDR_OEM_FIELD_DEV_SENSOR_MASK & V7_DIE_TEMP_SENSOR) | ((SDR_SYSMGR_CODE_NONE & SDR_OEM_FIELD_SYSMGR_CODE_MASK) << SDR_OEM_FIELD_SYSMGR_CODE_POS);
  pSDR->entityID = ENTITY_ID;
  pSDR->entityinstance = ENTITY_INSTANCE_BASE + twi_state.slotid;
  pSDR->sensorinit = 0x7f;
  pSDR->sensorcap = 0x58;
  ...
  pSDR->neg_thr_hysteresis = 2;
  pSDR->IDtypelen = 0xc0|11;
  strcpy(pSDR->IDstring, "V7 Die Temp");
  ...
  // ZYNQ 1.0VDD
  pSDR = (SDR_type_01h_t*) &SDRtbl[SDR_V7_1P0VDD_SENSOR];
  pSDR->hdr.recID_LSB = SDR_V7_1P0VDD_SENSOR;
  pSDR->hdr.recID_MSB = 0;
  pSDR->hdr.SDRversion = SDR_VERSION;
  pSDR->hdr.rectype = 0x01;
  pSDR->hdr.reclength = sizeof(SDR_type_01h_t)-sizeof(SDR_entry_hdr_t);
  pSDR->ownerID = twi_state.ipmbl_addr;
  pSDR->sensornum = V7_1P0VDD_SENSOR;
  pSDR->OEM = (SDR_OEM_FIELD_DEV_SENSOR_MASK & V7_1P0VDD_SENSOR) | ((SDR_SYSMGR_CODE_NONE & SDR_OEM_FIELD_SYSMGR_CODE_MASK) << SDR_OEM_FIELD_SYSMGR_CODE_POS);
  pSDR->entityID = ENTITY_ID;
  pSDR->entityinstance = ENTITY_INSTANCE_BASE + twi_state.slotid;
  pSDR->sensorinit = 0x7f;
  pSDR->sensorcap = 0x58;
  ...
  pSDR->pos_thr_hysteresis = 2;
  pSDR->neg_thr_hysteresis = 2;
  pSDR->IDtypelen = 0xc0|10;
  strcpy(pSDR->IDstring, "V7 +1.0VDD");
}
...
void Process_Sensors(int sensor_update_flag) {
  ...
  unsigned short assertion_mask, deassertion_mask;
    ...
    switch (pSD->active_context_code) {
      ...
      case SENSORACTV_AUXPAYLOADON:
        // context code for auxiliary power input.  Thresholds are active when:  aux power is selected AND payload power is on
