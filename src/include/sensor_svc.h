...
#define T2_TEMP_SENSOR						      (1)
#define PAYLOAD_12V_SENSOR					    (2)
#define BKEND_3p3V_SENSOR					      (3)
#define BKEND_1p2V_SENSOR               (4)
#define PGOOD_SENSOR                    (5)
#define ALARM_LEVEL_SENSOR              (6)
#define FPGA_CONFIG_SENSOR              (7)

#define FIRST_ANALOG_SENSOR             T2_TEMP_SENSOR
#define LAST_ANALOG_SENSOR              BKEND_1p2V_SENSOR

#define SDR_MMC								          (0)
#define SDR_HOTSWAP_SENSOR					    (1+HOTSWAP_SENSOR)
#define SDR_LOWER_TEMP_SENSOR					  (1+T2_TEMP_SENSOR)
#define SDR_PAYLOAD_12V_SENSOR				  (1+PAYLOAD_12V_SENSOR)
#define SDR_BKEND_3p3V_SENSOR					  (1+BKEND_3p3V_SENSOR)
#define SDR_BKEND_1p2V_SENSOR           (1+BKEND_1p2V_SENSOR)
